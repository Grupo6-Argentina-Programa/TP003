...
public class AtraccionService {
	...
	public Atraccion update(Integer id, String nombre, Double costo, Double duracion, Integer cupoActual, Integer cupoMaximo, Integer posicionX, Integer posicionY ) {
