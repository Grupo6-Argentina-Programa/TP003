...
<div class="modal-body">
	...
	<label for="cupoActual"
		...
		<input class="form-control" type="number" id="capacity" name="cupoActual"
		...
		<input class="form-control" type="number" id="capacity" name="cupoMaximo"
	...
	<div class="mb-3">
		...
		<input class="form-control" type="number" id="capacity" name="posicionX"
	...
	<div class="mb-3">
		...
		<input class="form-control" type="number" id="capacity" name="posicionY"
